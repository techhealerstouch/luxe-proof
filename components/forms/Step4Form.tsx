...
export function Step4Form({
  ...
  const getExistingFilePath = (fieldName: string): string | null => {
    if (fieldName === "watch_product_dial_analysis_image_path")
      return watchData?.dial_hands_and_date_scrutiny
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <FormField
          name="watch_product_dial_analysis_image_path"
          render={({ field }) => {
            ...
            return (
              <FormItem>
                ...
                <ExistingFileDisplay
                  fieldName="watch_product_dial_analysis_image_path"
                  field={field}
                />
